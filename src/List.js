...
export default class List extends PureComponent {
    ...
    getItemRenderer() {
        ...
        const hasRender = typeof render !== 'undefined';

        warning(
            !(hasChildren && hasRender),
            'ReactIntersectionList: cannot use children and render props as render function at the same time.',
        );
        ...
        return hasRender ? render : (index, key) => <div key={key}>{index}</div>;
    }
